package com.sunfusheng.small.lib.framework.okhttp;
...
import com.sunfusheng.small.lib.framework.okhttp.builder.GetBuilder;
import com.sunfusheng.small.lib.framework.okhttp.builder.OtherRequestBuilder;
import com.sunfusheng.small.lib.framework.okhttp.builder.PostFileBuilder;
import com.sunfusheng.small.lib.framework.okhttp.builder.PostFormBuilder;
import com.sunfusheng.small.lib.framework.okhttp.builder.PostStringBuilder;
import com.sunfusheng.small.lib.framework.okhttp.callback.OkHttpCallBack;
import com.sunfusheng.small.lib.framework.okhttp.cookie.HttpsCoder;
import com.sunfusheng.small.lib.framework.okhttp.cookie.OkHttpCookieUtils;
import com.sunfusheng.small.lib.framework.okhttp.cookie.SimpleCookieJar;
import com.sunfusheng.small.lib.framework.okhttp.request.RequestCall;
...
public class OkHttpProxy {
    ...
    public static void printUrlParamsInfo(String url, Map<String, String> params) {
        if (!DroidFramework.LOG) return ;
        if (TextUtils.isEmpty(url) || params == null) return;
        if (url.contains("Statistics")) return ;
    ...
    public static void printResponseInfo(Request request, String response, String status) {
        ...
        if (!TextUtils.isEmpty(path)) {
            if (path.contains("Statistics")) return ;
